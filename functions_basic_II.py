...
# mylist = [7,3,5,7,9]
# print(first_plus_length(mylist))
...
# num1 = [7,4,7,5,8,7, 12]
# num2 = [2]
# print(values_greater_than_second(num1))
# print(values_greater_than_second(num2))
...
#  a list whose length is equal to the given size, and whose values 
...
#     return newlist
# print(thislengththatvalue(6,16))
# print(thislengththatvalue(4,34))
